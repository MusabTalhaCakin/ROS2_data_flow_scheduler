...
public:
   ...
   * @details It performs necessary clean-up when a DFSClient object is
   * destroyed.
   */
  ~DFSClient() {
    close_socket();
   ...
   * @return True if the connection is established successfully, false
   * otherwise.
   */
   ...
   */
  bool send_raw_data(const void *, std::uint32_t) const;
   ...
   */
  int read_raw_data(void *, std::uint32_t) const;
