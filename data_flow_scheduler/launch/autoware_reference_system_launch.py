...
def generate_launch_description():
    ...
    s_node1 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '1', str(60000), str(0), 
        'FrontLidarDriver', 'FrontLidarDriver'],
        output='screen'
    )
    s_node2 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '1', str(60001), str(0), 
        'RearLidarDriver', 'RearLidarDriver'],
        output='screen'
    )
    s_node3 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '1', str(60002), str(0), 
        'PointCloudMap', 'PointCloudMap'],
        output='screen'
    )
    s_node4 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '1', str(60003), str(0), 
        'Visualizer', 'Visualizer'],
        output='screen'
    )
    s_node5 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '1', str(60004), str(0), 
        'Lanelet2Map', 'Lanelet2Map'],
        output='screen'
    )
    s_node6 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '1', str(60005), str(0), 
    ...
    t_node1 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2', str(60000), str(2048), 'PointsTransformerFront', 
        'FrontLidarDriver', 'PointsTransformerFront'],
        output='screen'
    )
    t_node2 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60001), str(2048), 'PointsTransformerRear', 
        'RearLidarDriver', 'PointsTransformerRear'],
        output='screen'
    )
    t_node3 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60002), str(2048), 'VoxelGridDownsampler', 
       'PointCloudFusion', 'VoxelGridDownsampler'],
        output='screen'
    )
    t_node4 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60003), str(2048), 'PointCloudMapLoader', 
        'PointCloudMap', 'PointCloudMapLoader'],
        output='screen'
    )
    t_node5 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60004), str(2048), 'RayGroundFilter', 
        'PointCloudFusion', 'RayGroundFilter'],
        output='screen'
    )
    t_node6 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60005), str(2048), 'ObjectCollisionEstimator', 
        'EuclideanClusterDetector', 'ObjectCollisionEstimator'],
        output='screen'
    )
    t_node7 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60006), str(2048), 'MPCController', 
        'BehaviorPlanner', 'MPCController'],
        output='screen'
    )
    t_node8 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60007), str(2048), 'ParkingPlanner', 
        'Lanelet2MapLoader', 'ParkingPlanner'],
        output='screen'
    )
    t_node9 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '2',str(60008), str(2048), 'LanePlanner', 
    ...
    f_node1 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '3',str(600000), str(4096), 'PointCloudFusion', 
        'PointsTransformerFront', 'PointsTransformerRear', "PointCloudFusion"],
        output='screen'
    )
    f_node2 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '3',str(600001), str(4096), 'NDTLocalizer', 
        'VoxelGridDownsampler', 'PointCloudMapLoader', 'NDTLocalizer'],
        output='screen'
    )
    f_node3 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '3',str(600002), str(4096), 'VehicleInterface', 
        'MPCController', 'BehaviorPlanner', 'VehicleInterface'],
        output='screen'
    )
    f_node4 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '3',str(600003), str(4096), 'Lanelet2GlobalPlanner', 
        'Visualizer', 'NDTLocalizer', 'Lanelet2GlobalPlanner'],
        output='screen'
    )
    f_node5 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '3',str(600004), str(4096), 'Lanelet2MapLoader', 
    ...
    cy_node1 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '4', str(600000), str(8192), 'BehaviorPlanner', 
    ...
    i_node1 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '5',str(60000), str(2048), 'EuclideanClusterDetector', 
    ...
    co_node1 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '6', str(60000), str(0), 'VehicleDBWSystem', 
        'VehicleInterface'],
        output='screen'
    )
    co_node2 = ExecuteProcess(
        cmd=['taskset', '-c', '0', bash_file_path, '6', str(60001), str(0), 'IntersectionOutput', 
