...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'PointsTransformerFront', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'PointsTransformerRear', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'VoxelGridDownsampler', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'PointCloudMapLoader', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'RayGroundFilter', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'ObjectCollisionEstimator', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'MPCController', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'ParkingPlanner', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '2', str(2048), 'LanePlanner', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '3', str(4096), 'PointCloudFusion', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '3', str(4096), 'NDTLocalizer', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '3', str(4096), 'VehicleInterface', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '3', str(4096), 'Lanelet2GlobalPlanner', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '3', str(4096), 'Lanelet2MapLoader', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '4', str(8192), 'BehaviorPlanner', 
>>>>>>> Stashed changes
...
=======
        cmd=['taskset', '-c', '7', bash_file_path, '5', str(2048), 'EuclideanClusterDetector', 
>>>>>>> Stashed changes
